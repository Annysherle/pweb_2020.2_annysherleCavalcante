...
public class DependentesController {
	...
	public ModelAndView listarDependente() {
		List<Dependentes> lista = dependenteRepo.findAll();
	...
	public ModelAndView formAdicionarDependente() {
		...
		modelAndView.addObject(new Dependentes(null, null, null, null, null, null));
		return modelAndView;
	}

	@PostMapping("/adicionarDependente")
	public String AdicionarDependentes(Dependentes d) {
	...
	public ModelAndView formEditarDependentes(@PathVariable("id") long id) {
		Dependentes dependente = dependenteRepo.findById(id)
	...
	public ModelAndView editarDependentes(@PathVariable("id") long id, Dependentes dependente) {
	...
	public ModelAndView removerDependentes(@PathVariable("id") long id) {
		Dependentes aRemover = dependenteRepo.findById(id)
				.orElseThrow(() -> new IllegalArgumentException("ID inválido" + id));
